PREFIX := /usr
INSTALLDIR := $(PREFIX)/usr/share/emulationstation/themes/simple-dark
...
install:
	...
	cp -a 3do 3ds amiga amstradcpc apple2 apps arcade art atari800 atari2600 atari5200 atari7800 atarifalcon atarijaguar atarijaguarcd atarilynx \
          ...
          macintosh mame mastersystem megadrive moto msx n64 nds neogeo nes ngp ngpc odyssey2 pc pcengine ports ps2 psp psx retropie saturn \
          scummvm sega32x segacd sfc sg-1000 snes solarus trs-80 vectrex videopac virtualboy wii wonderswan wonderswancolor xbox zmachine \
